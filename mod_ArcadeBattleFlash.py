                ...
                if BigWorld.isKeyDown(MeltyElement.illuminateKey) and is_down and mods == MeltyElement.illuminateModifier:
                    ...
                    if currSight:
                        ...
                        if ctrl is not None:
                            ...
                            battle_page.components['battlePlayerMessages'].as_showRedMessageS(None, arcademsg)
                    ...
                    arcadeBattleFlash.toggleIlluminateSight(illuminatedToggle, MeltyElement.illuminateColor[0], MeltyElement.illuminateColor[1], MeltyElement.illuminateColor[2])
